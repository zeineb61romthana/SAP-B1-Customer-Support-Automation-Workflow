...
### Demo Video
[<img src="https://via.placeholder.com/600x300.png?text=Watch+SAP+B1+Automation+Demo" alt="SAP B1 Workflow Demo" />](https://github.com/zeineb61romthana/SAP-B1-Customer-Support-Automation-Workflow/blob/main/demo.mp4)
